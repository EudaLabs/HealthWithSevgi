...
![A screenshot of a medical exam AI-generated content may be incorrect.](media/image1.png)
...
![A screenshot of a medical information AI-generated content may be incorrect.](media/image2.png)
...
> AI Predicted: NOT at Risk
> AI Predicted: AT RISK
> Actually NOT at Risk
> ✅ Correctly called safe
> (True Negative)
> ⚠️ Unnecessary alarm — patient was fine
> (False Positive — costs resources but not a safety risk)
> Actually AT RISK
> ❌ MISSED — patient returned to hospital
> (False Negative — the most dangerous error)
...
![A screenshot of a medical survey AI-generated content may be incorrect.](media/image8.png)
